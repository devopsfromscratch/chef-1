...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "devopsfromscratch-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/devopsfromscratch"
  #   chef.validation_client_name = "devopsfromscratch-validator"
  #   chef.validation_key_path = ".chef/devopsfromscratch-validator.pem"
  # end
end
